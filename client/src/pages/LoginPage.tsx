    ...
    return (
        <div className='log-page'>
            ...
            <div className='log-page__content'>
                ...
                <form>
                    <MyInput id={'log-page__email-input'} title={'Enter your email'} value={inputValue} setValue={setValue} type={'text'} placeHolder={'james_bond_007@gmail.com'} />
                    <MyInput id={'log-page__password-input'} title={'Enter your password'} value={inputValue} setValue={setValue} type={'password'} placeHolder={'******'} />
